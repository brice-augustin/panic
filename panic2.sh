...
contexte[15]="Henri (Responsable du Bonheur)|Bonjour, J'ai oublié mon mot de passe, vous pouvez me le réinitialiser svp ? Mon login sur FTP1 est 'henri'. Merci !|15|ftp1|chgpass|r"
...
contexte[18]="Baptiste (Admin système)|J'ai pas les droits pour lire /var/log/auth.log sur WWW1, tu peux changer ça stp ? Mon login est 'sysadmin1', il suffit de m'ajouter au groupe propriétaire de ce fichier.|18|www1|addgrp|r"
